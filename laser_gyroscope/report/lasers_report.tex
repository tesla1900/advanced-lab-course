...
value can be directly compared with the theoretical gyroscope sensitivity described in Eq. \ref{eq:gyroscope_sensitivity} \cite{Groh2021}.
...
\subsection{Task 1: Getting Started}

\subsection{Task 2: Allan Deviation}

\subsection{Task 3: Rotation Rate of Earth}
