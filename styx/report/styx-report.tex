            ...
            We determine the intensity distributions of secondary cosmic rays using a drift chamber detector.
			 ...
			 leave it overnight to collect secondary cosmic ray events. After applying straw-by-straw calibration method,
			  we reconstruct the event tracks and study the various relations between number of hits and tracks, the angular
			   ...
			   and low energy muons penetrating through the building. \textcolor{red}{add about the algorithm} We also observed a linear correlation between the track and 
			   segment angles as well as an anticorrelation at $\theta = \pm \SI{30}{\degree}$, where the latter was attributed to 
...
$\cos^2 \theta$. \textcolor{red}{add things about the algorith} \par 

Using this algorithm, we observe the distribution between the track and segment angle, which showed a linear correlation throughout 
