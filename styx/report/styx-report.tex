...
% raw data taken overnight to reconstruct the muon tracks. We observe the 
...
% We then observed the plots generated by the ROOT output file and compared the difference between the uncalibrated and 
% calibrated data. Fig. \ref{fig:calib_drift_layer} show the uncalibrated and calibrated drift time distributions obtained for Module 1, Layer 1, Module 1, Layer 2, Module 2, Layer 2, and 
% Module 3, Layer 1. The last configuration was chosen as the distribution from the uncalibrated data showed the most noise. The first two 
% configurations were chosen for comparison with other distributions. \par



% \begin{figure*}[htb!]
% 	\centering
% 	\subfloat[Module 1, Layer 1 (Uncalibrated)]{{\includegraphics[width=0.47\columnwidth]{uncalib_drift_m1l1.png}}}
% 	\quad
% 	\centering
% 	\subfloat[Module 1, Layer 1 (Calibrated)]{{\includegraphics[width=0.47\columnwidth]{calib_drift_m1l1.png}}}
% 	\quad
% 	\centering
% 	\subfloat[Module 1, Layer 2 (Uncalibrated)]{{\includegraphics[width=0.47\columnwidth]{uncalib_drift_m1l2.png}}}
% 	\quad
% 	\centering
% 	\subfloat[Module 1, Layer 2 (Calibrated)]{{\includegraphics[width=0.47\columnwidth]{calib_drift_m1l2.png}}}
% 	\quad
% 	\centering
% 	\subfloat[Module 2, Layer 2 (Uncalibrated)]{{\includegraphics[width=0.47\columnwidth]{uncalib_drift_m2l2.png}}}
% 	\quad
% 	\centering
% 	\subfloat[Module 2, Layer 2 (Calibrated)]{{\includegraphics[width=0.47\columnwidth]{calib_drift_m2l2.png}}}
% 	\quad
% 	\centering
% 	\subfloat[Module 3, Layer 1 (Uncalibrated)]{{\includegraphics[width=0.47\columnwidth]{uncalib_drift_m3l1.png}}}
% 	\quad
% 	\centering
% 	\subfloat[Module 3, Layer 1 (Calibrated)]{{\includegraphics[width=0.47\columnwidth]{calib_drift_m3l1.png}}}
% 	\caption{The uncalibrated (left) and calibrated (right) drift time 
% 	distributions for different layers and modules of the apparatus.}
% 	\label{fig:calib_drift_layer}
% \end{figure*}
